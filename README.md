...
<sub>*Figure 1:* Example of a plot from the inference framework: correlation of nitric oxide (NO) with a standardised mortality rate of chronic lower respiratory disease. R² = coefficient of determination.</sub>
